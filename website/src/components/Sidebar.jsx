...
const Sidebar = () => {
  ...
  const normalLink = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg  text-md text-gray-700 datk:text-gray-200 dark:hover:text-black hover:bg-light-gray m-2';
  return (
      ...
      {activeMenu && (<>
        <div className='flex justify-between items-center'>
          <Link to ="/" onClick = {()=>setActiveMenu(false)} className='items-center gap-3 ml-3 mt-4 flex text-xl font-extrabold tracking-tight dark:text-white text-slate-900'>
            <SiShopware/> <span>AggieImpact</span>
          </Link>
